	...
	namespace Api
	{
		namespace Types
		{
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_BoolOptional GetDisabled () const
					{
						return m_Response.GetBoolean("disabled");
					}
			/// <summary>
			...
			*/
			class ChatMessage : public  GameSparks::Core::GSTypedResponse
			{
			public:
				ChatMessage(const GameSparks::Core::GSData& data)
					: GSTypedResponse(data)
				{
			...
			*/
			class PlayerMessage : public  GameSparks::Core::GSTypedResponse
			{
			public:
				PlayerMessage(const GameSparks::Core::GSData& data)
					: GSTypedResponse(data)
				{
			...
			/// </summary>
					// method type 4
					Optional::t_BoolOptional GetSeen () const
					{
						return m_Response.GetBoolean("seen");
					}
			/// <summary>
