	...
	namespace Api
	{
		namespace Requests
		{
			...
			*/
			...
			/// </summary>
			AmazonBuyGoodsRequest& SetCurrencyCode( const gsstl::string& currencyCode )
			{
			...
			/// </summary>
			AmazonBuyGoodsRequest& SetSubUnitPrice( double subUnitPrice )
			{
			...
			*/
			class DismissMultipleMessagesRequest : public GameSparks::Core::GSTypedRequest < DismissMultipleMessagesRequest, GameSparks::Api::Responses::DismissMultipleMessagesResponse >
			{
			public:
				DismissMultipleMessagesRequest(Core::GS& gsInstance)
					: GSTypedRequest(gsInstance, ".DismissMultipleMessagesRequest")
				{
			...
			/// </summary>
			DismissMultipleMessagesRequest& SetMessageIds( gsstl::vector<gsstl::string> messageIds )
			{
				m_Request.AddStringList("messageIds", messageIds);
				return *this;
			}
			};
			...
			*/
			...
			/// The price of this purchase
			/// </summary>
			GooglePlayBuyGoodsRequest& SetSubUnitPrice( double subUnitPrice )
			{
				m_Request.AddNumber("subUnitPrice", subUnitPrice);
				return *this;
			}
			...
			*/
			...
			/// The price of this purchase
			/// </summary>
			IOSBuyGoodsRequest& SetSubUnitPrice( double subUnitPrice )
			{
				m_Request.AddNumber("subUnitPrice", subUnitPrice);
				return *this;
			}
			...
			*/
			class ListMessageDetailRequest : public GameSparks::Core::GSTypedRequest < ListMessageDetailRequest, GameSparks::Api::Responses::ListMessageDetailResponse >
			{
			public:
				ListMessageDetailRequest(Core::GS& gsInstance)
					: GSTypedRequest(gsInstance, ".ListMessageDetailRequest")
				{
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			ListMessageDetailRequest& SetEntryCount( long entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// </summary>
			ListMessageDetailRequest& SetInclude( const gsstl::string& include )
			{
			...
			/// The offset (page number) to start from (default=0)
			/// </summary>
			ListMessageDetailRequest& SetOffset( long offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			/// </summary>
			ListMessageDetailRequest& SetStatus( const gsstl::string& status )
			{
				m_Request.AddString("status", status);
				return *this;
			}
			};
			...
			*/
			class ListTeamsRequest : public GameSparks::Core::GSTypedRequest < ListTeamsRequest, GameSparks::Api::Responses::ListTeamsResponse >
			{
			public:
				ListTeamsRequest(Core::GS& gsInstance)
					: GSTypedRequest(gsInstance, ".ListTeamsRequest")
				{
			...
			/// </summary>
			ListTeamsRequest& SetEntryCount( long entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// The offset (page number) to start from (default=0)
			/// </summary>
			ListTeamsRequest& SetOffset( long offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			/// </summary>
			ListTeamsRequest& SetTeamNameFilter( const gsstl::string& teamNameFilter )
			{
				m_Request.AddString("teamNameFilter", teamNameFilter);
				return *this;
			}
			/// <summary>
			/// An optional filter to return teams of a particular type
			/// </summary>
			ListTeamsRequest& SetTeamTypeFilter( const gsstl::string& teamTypeFilter )
			{
				m_Request.AddString("teamTypeFilter", teamTypeFilter);
				return *this;
			}
			};
			...
			*/
			...
			/// </summary>
			ListVirtualGoodsRequest& SetIncludeDisabled( bool includeDisabled )
			{
				m_Request.AddBoolean("includeDisabled", includeDisabled);
				return *this;
			}
			/// <summary>
			...
			*/
			...
			/// The ISO 4217 currency code representing the real-world currency used for this transaction.
			/// </summary>
			PsnBuyGoodsRequest& SetCurrencyCode( const gsstl::string& currencyCode )
			{
				m_Request.AddString("currencyCode", currencyCode);
				return *this;
			}
			...
			/// The price of this purchase
			/// </summary>
			PsnBuyGoodsRequest& SetSubUnitPrice( double subUnitPrice )
			{
				m_Request.AddNumber("subUnitPrice", subUnitPrice);
				return *this;
			}
			...
			*/
			...
			/// The ISO 4217 currency code representing the real-world currency used for this transaction.
			/// </summary>
			SteamBuyGoodsRequest& SetCurrencyCode( const gsstl::string& currencyCode )
			{
				m_Request.AddString("currencyCode", currencyCode);
				return *this;
			}
			...
			/// The price of this purchase
			/// </summary>
			SteamBuyGoodsRequest& SetSubUnitPrice( double subUnitPrice )
			{
				m_Request.AddNumber("subUnitPrice", subUnitPrice);
				return *this;
			}
			...
			*/
			class UpdateMessageRequest : public GameSparks::Core::GSTypedRequest < UpdateMessageRequest, GameSparks::Api::Responses::UpdateMessageResponse >
			{
			public:
				UpdateMessageRequest(Core::GS& gsInstance)
					: GSTypedRequest(gsInstance, ".UpdateMessageRequest")
				{
			...
			/// </summary>
			UpdateMessageRequest& SetMessageId( const gsstl::string& messageId )
			{
				m_Request.AddString("messageId", messageId);
				return *this;
			}
			...
			/// </summary>
			UpdateMessageRequest& SetStatus( const gsstl::string& status )
			{
				m_Request.AddString("status", status);
				return *this;
			}
			...
			*/
			...
			/// The price of this purchase
			/// </summary>
			WindowsBuyGoodsRequest& SetSubUnitPrice( double subUnitPrice )
			{
				m_Request.AddNumber("subUnitPrice", subUnitPrice);
				return *this;
			}
			...
			*/
			...
			/// </summary>
			XBOXLiveConnectRequest& SetDisplayName( const gsstl::string& displayName )
			{
				m_Request.AddString("displayName", displayName);
				return *this;
			}
			...
			*/
			class XboxOneConnectRequest : public GameSparks::Core::GSTypedRequest < XboxOneConnectRequest, GameSparks::Api::Responses::AuthenticationResponse >
			{
			public:
				XboxOneConnectRequest(Core::GS& gsInstance)
					: GSTypedRequest(gsInstance, ".XboxOneConnectRequest")
				{
			...
			/// Indicates that the server should not try to link the external profile with the current player.  If false, links the external profile to the currently signed in player.  If true, creates a new player and links the external profile to them.  Defaults to false.
			/// </summary>
			XboxOneConnectRequest& SetDoNotLinkToCurrentPlayer( bool doNotLinkToCurrentPlayer )
			{
				m_Request.AddBoolean("doNotLinkToCurrentPlayer", doNotLinkToCurrentPlayer);
				return *this;
			}
			...
			/// Indicates whether the server should return an error if an account switch would have occurred, rather than switching automatically.  Defaults to false.
			/// </summary>
			XboxOneConnectRequest& SetErrorOnSwitch( bool errorOnSwitch )
			{
				m_Request.AddBoolean("errorOnSwitch", errorOnSwitch);
				return *this;
			}
			...
			/// </summary>
			XboxOneConnectRequest& SetSandbox( const gsstl::string& sandbox )
			{
				m_Request.AddString("sandbox", sandbox);
				return *this;
			}
			/// <summary>
			/// An optional segment configuration for this request.
			/// If this request creates a new player on the gamesparks platform, the segments of the new player will match the values provided
			/// </summary>
			XboxOneConnectRequest& SetSegments( const GameSparks::Core::GSRequestData& segments )
			{
				m_Request.AddObject("segments", segments);
				return *this;
			}
			...
			/// Indicates that the server should switch to the supplied profile if it isalready associated to a player. Defaults to false.
			/// </summary>
			XboxOneConnectRequest& SetSwitchIfPossible( bool switchIfPossible )
			{
				m_Request.AddBoolean("switchIfPossible", switchIfPossible);
				return *this;
			}
			...
			/// Indicates that the associated players displayName should be kept in syn with this profile when it's updated by the external provider.
			/// </summary>
			XboxOneConnectRequest& SetSyncDisplayName( bool syncDisplayName )
			{
				m_Request.AddBoolean("syncDisplayName", syncDisplayName);
				return *this;
			}
			...
			/// </summary>
			XboxOneConnectRequest& SetToken( const gsstl::string& token )
			{
				m_Request.AddString("token", token);
				return *this;
			}
			};
